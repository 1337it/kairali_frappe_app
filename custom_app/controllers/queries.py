...
def item_query(doctype, txt, searchfield, start, page_len, filters, as_dict=False):
	...
	return frappe.db.sql(
		"""select
			it.item_name, it.item_code as name, it.description as description, (SELECT sum(sl.actual_qty) FROM `tabStock Ledger Entry` sl WHERE sl.item_code = it.item_code GROUP BY sl.item_code) as available_qty
from tabItem it
